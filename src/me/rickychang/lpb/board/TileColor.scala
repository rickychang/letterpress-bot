 ...
 */
sealed abstract class TileColor(description: String, shortName: String, currrentVal: Short, playerPotential: Short, opponentPotential: Short) {
...
case object OpponentOccupied extends TileColor("Opponent Occupied", "r", -1, 1, -1)
case object OpponentDefended extends TileColor("Opponent Defended", "R", -1, 0, 0)
